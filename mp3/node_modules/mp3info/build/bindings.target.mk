...
OBJS := \
	...
	$(obj).target/$(TARGET)/src/node_mp3info.o

# Add to the list of files we specially track dependencies for.
all_deps += $(OBJS)

# Make sure our dependencies are built before any of us.
$(OBJS): | $(builddir)/libmp3info.a $(obj).target/deps/mp3info/libmp3info.a
...
$(obj).target/bindings.node: $(OBJS) $(obj).target/deps/mp3info/libmp3info.a FORCE_DO_CMD
